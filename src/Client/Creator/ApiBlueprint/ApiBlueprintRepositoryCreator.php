...
namespace Leankoala\LeanApiBundle\Client\Creator\ApiBlueprint;
...
/**
 * Class ApiBlueprintRepositoryCreator
 *
 ...
 * created 2020-07-01
 */
class ApiBlueprintRepositoryCreator implements RepositoryCreator
{
    ...
    public function create($repositoryName, $endpoints, $constants = [], $repositoryMeta = [])
    {
        ...
        $classContent = $this->template->render('ApiBlueprint/Snippets/repository.md.twig',
            [
                'repository' => $repositoryName,
                'endpoints' => $endpoints,
                'jsDocs' => $jsDocs,
